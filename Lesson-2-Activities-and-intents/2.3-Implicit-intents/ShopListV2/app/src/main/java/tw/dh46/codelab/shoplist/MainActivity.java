...
public class MainActivity extends AppCompatActivity {
    ...
    private EditText mSearchStoreEditText;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mSearchStoreEditText = findViewById(R.id.edt_search_store);
    ...
    public void searchStore(View view) {
        if (mSearchStoreEditText != null) {
            String loc = mSearchStoreEditText.getText().toString();
